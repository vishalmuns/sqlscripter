...
SQL.Line.prototype.mousemove = function(e){
	if (IE) { 
    	SQL.Designer.line.mouseX = event.clientX + document.body.scrollLeft;
    	SQL.Designer.line.mouseY = event.clientY + document.body.scrollTop;
    } else {  
...
SQL.TablePrototype.prototype.mousemove = function(e){
	if (IE) { 
    	SQL.Designer.newprototype.x = event.clientX + document.body.scrollLeft;
    	SQL.Designer.newprototype.y = event.clientY + document.body.scrollTop;
    } else {  
...
SQL.NotePrototype.prototype.mousemove = function(e){
	...
	if (IE) { 
    	SQL.Designer.newprototypenote.x = event.clientX + document.body.scrollLeft;
    	SQL.Designer.newprototypenote.y = event.clientY + document.body.scrollTop;
    } else {  
...
SQL.Relation.prototype.init = function(owner, row1, row2, indexL, indexR) {
	...
	this.redraw();
	this.row2.updateKey();
	this._ec.push(OZ.Event.add(this.dom[1], "click", this.bind(this.click)));
	this._ec.push(OZ.Event.add(this.dom[1], "dblclick", this.bind(this.dblclick)));
	this._ec.push(OZ.Event.add(this.selectionL, "click", this.bind(this.clickselectionL)));
	this._ec.push(OZ.Event.add(this.selectionL, "dblclick", this.bind(this.dblclick)));
	this._ec.push(OZ.Event.add(this.selectionR, "click", this.bind(this.clickselectionR)));
...
SQL.Relation.prototype.dblclick = function() {
	this.owner.relationManager.relationedit();
}

SQL.Relation.prototype.clickselectionL = function() {
	this.onclicking = true;
	var that = this;
	setTimeout(function(){that.onclicking = false;},200);
...
SQL.Relation.prototype.clickselectionR = function() {
	this.onclicking = true;
	var that = this;
	setTimeout(function(){that.onclicking = false;},200);
...
SQL.Table.prototype.mouseDown = function(e) { /* long press */
	var that = this;
	this.longpress = false;
	if(!this.pressTimer) this.pressTimer = setTimeout(function(){ 
		that.contextMenu(e);
		that.longpress = true; 
	},1000);
}
